...
class Aglomerativo:
    ...
    def CompleteLink(self, ClusterA, ClusterB):
        """
        Regresa la distancia maxima entre dos clusters
        """
        Dist = []
        ...
        print("\n     Distancia entre los puntos mas lejanos de los grupos:",
              ClusterA.indicador, " y ", ClusterB.indicador, "es de:", max(Dist))
        return max(Dist)
