...
class Aglomerativo:
    ...
    def MeanDistance(self, ClusterA, ClusterB):
        """
        Regresa la distancia entre las medias de dos clusters
        """
        ...
        Dist = (dis(pro1, pro2))
        print("\n     Distancia entre la media de los grupos:" , ClusterA.indicador," y ", ClusterB.indicador, "es de:", Dist)
        return Dist
