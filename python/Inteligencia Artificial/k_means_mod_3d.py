...
class KMeans:
    ...
    def datos_aleatorios(self, muestras=50):
        ...
        self.UniversoNorm = self.Universo / np.linalg.norm(self.Universo)
        #print("Universo normalizado: ", self.UniversoNorm)
...
if __name__ == '__main__':
    ...
    C = 3  # int(input("Ingrese el numero de dimensiones:"))
    ...
    kmeans.datos_aleatorios(muestras=mue)
    kmeans.acomodar()
    print("-- Iteraciones: ", ite, " --")
    type(ite)
