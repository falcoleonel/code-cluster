...
{ 
  ...
  public void paint (Graphics g)
  {
    ...
    radius*6/10, radius*3/15, Color.orange);
    needleMin.setFormat (xCen, yCen,
    radius*8/10, radius*2/15, Color.black);
    needleSec.setFormat (xCen, yCen,
    radius*9/10, radius*1/15, Color.green);
...
public boolean imageUpdate(Image img, int infoflags,
    int x, int y, int width, int height)
  {
    ...
    return (infoflags & (ImageObserver.ALLBITS | ImageObserver.ERROR));
  }
  */
}