...
public class Camara {
    ...
    public void ajustarPosicion(Coordenada posicion) {
        this.posicion = posicion;
    }
    
    public Coordenada obtenerRotacion() {
        return rotacion;
    }
    
    public void ajustarRotacion(Coordenada rotacion) {
        this.rotacion = rotacion;
    }
    ...
    public List<Point> proyectar(Poliedro poliedro) {
        ...
        return poliedro.puntos.stream().map((Coordenada p) -> 
            rotacion
