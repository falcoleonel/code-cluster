...
public class CubeScale {

	public static void drawCube(Scale vector, Scale growth) {
		...
		for(int index = 0; index < arrX.length; index++) {
			...
			tempX = vector.x + (arrX[index] * growth.x);
			tempY = vector.y + (arrY[index] * growth.y);
		...
		for(int index = 0; index < arrX.length; index++) {
			...
			tempZ = vector.z + growth.z; //Proyeccion 
			tempX = vector.x + (arrX[index] * growth.x);
			tempY = vector.y + (arrY[index] * growth.y);
