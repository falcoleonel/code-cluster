...
public class Painting {
    ...
    public static void CuboPerspectivaProyeccion(int x1, int y1, int z1, int large, Color c) {
        ...
        for(int cont = 0; cont < arrX.length; cont++) {
            ...
            y = Pixel.height - (yc + (tempY - yc)*((z - zc) / (z1 - zc)));
        ...
        for(int cont = 0; cont < arrX.length; cont++) {
            ...
            y = Pixel.height - (yc + (tempY - yc)*((z - zc) / (tempZ - zc)));
            System.out.println(Pixel.height);
            //		System.out.println(x + " - " + y);
